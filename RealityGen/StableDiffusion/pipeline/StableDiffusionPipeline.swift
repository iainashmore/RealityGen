...
public struct PipelineProgress {
    ...
    public var currentImagesArray: [MLMultiArray]? {
        try! pipeline.decodeToImages2(currentLatentSamples, configuration: configuration)
    }
